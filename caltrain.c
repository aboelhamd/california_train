...
void station_wait_for_train(struct station *station) {
	...
	while (station->avail_seats == station->ready_passen)
		pthread_cond_wait(&station->cond_avail_seats, &station->mutex);

	station->ready_passen++;

//	printf("After : wait_passen %d , ready_passen %d , avail_seats %d\n",
//			station->wait_passen, station->ready_passen, station->avail_seats);
...
//	printf("On board : wait_passen %d , ready_passen %d , avail_seats %d\n",
//			station->wait_passen, station->ready_passen, station->avail_seats);
